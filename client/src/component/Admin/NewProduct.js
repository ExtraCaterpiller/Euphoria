...
import { useCreateProductAdminMutation, clearError } from '../../features/Products/productSlice';
import { useSelector, useDispatch } from 'react-redux';
import { toast, Bounce } from 'react-toastify'
import { categories, sizes, styles, genders } from '../../data/data';
...
const NewProduct = () => {
    ...
    const [createProductAdmin, { isSuccess }] = useCreateProductAdminMutation()
    ...
    const createProductSubmitHandler = async (e) => {
        e.preventDefault()
        setLoading(true)
        if(!name || !price || !description || !category || !style || !gender || images.length===0){
    ...
    <Metadata title="Create Product" />
      ...
      <div className='board-desktop'>
        ...
        <div className="newProductContainer">
            <h1 className='newProduct-title'>Create Product</h1>
          <form
                ...
                <FormGroup row>
                    {
                        sizes.map((sizeName, index) => (
                            <div className='newProduct-select-size' key={index}>
